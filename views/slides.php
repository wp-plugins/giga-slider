			...
			<div class="body">
				...
				<div class="form-group">
					...
					onchange="rcs_slideTypeChange(this)">
						...
						<option value="youtube" <?php selected($type, 'youtube') ?>><?php _e('YouTube', 'rc_slider') ?></option>
						<option value="vimeo" <?php selected($type, 'vimeo') ?>><?php _e('Vimeo', 'rc_slider') ?></option>
					</select>
				</div>
				<br />
				...
				id="image_container_<?php echo $i ?>">
					<div class="form_container">
						...
						<div class="form-group slide">
							...
							<input class="widefat" type="text" name="slides[<?php echo $i ?>][url]" id="slides_url_<?php echo $i ?>" 
							value="<?php echo $url ?>" />
						</div>
						
						<div class="form-group lastSlide">
							<label class="label" for="slides_target_<?php echo $i ?>"><?php _e('Open link in', 'rc_slider') ?></label></th>
							<select class="widefat" name="slides[<?php echo $i ?>][target]" id="slides_target_<?php echo $i ?>">
						...
						<div class="form-group slide">
							...
							<input class="widefat" type="text" name="slides[<?php echo $i ?>][caption]" id="slides_caption_<?php echo $i ?>" 
							value="<?php echo $caption ?>" />
						</div>
						
						<div class="form-group slide">
							<label class="label"><?php _e('Caption URL', 'rc_slider') ?></label>
							<input class="widefat" type="text" name="slides[<?php echo $i ?>][caption_url]" id="slides_caption_url_<?php echo $i ?>" 
						...
						<div class="form-group slide">
							...
							<select class="widefat" name="slides[<?php echo $i ?>][caption_url_target]" id="slides_caption_url_target_<?php echo $i ?>">
						...
						<div class="form-group slide">
							...
							<textarea class="widefat slides_caption_css" rows="2" name="slides[<?php echo $i ?>][caption_css]" id="slides_caption_css_<?php echo $i ?>" 
